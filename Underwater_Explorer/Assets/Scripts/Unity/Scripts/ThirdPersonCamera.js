...
* 		third person camera that unity provides
*
*	NOTE2: this camera controls the players facing direction
* 		but does not allow for free rotation of the Camera
*		so i also added the MouseLook.cs
****************************************************/
